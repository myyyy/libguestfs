...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/installcheck.sh.in $(srcdir)/pick-guests.pl.in \
	$(srcdir)/podwrapper.pl.in $(srcdir)/run.in \
	$(top_srcdir)/builder/test-config/virt-builder/repos.d/test-index.conf.in \
	$(top_srcdir)/builder/test-website/virt-builder/repos.d/libguestfs.conf.in \
	$(top_srcdir)/common-rules.mk $(top_srcdir)/configure \
	$(top_srcdir)/php/extension/php-for-tests.sh.in \
	$(top_srcdir)/ruby/ext/guestfs/extconf.rb.in AUTHORS COPYING \
	COPYING.LIB TODO build-aux/compile build-aux/config.guess \
	build-aux/config.rpath build-aux/config.sub build-aux/depcomp \
	build-aux/install-sh build-aux/ltmain.sh build-aux/missing \
	build-aux/ylwrap
am__append_1 = gnulib/tests
am__append_2 = daemon tests/daemon

# Tests - order is important.
am__append_3 = appliance tests/qemu \
	tests/guests tests/c-api tests/tmpdirs \
	tests/protocol tests/events \
	tests/parallel tests/create tests/disks \
	tests/discard tests/mountable \
	tests/network tests/lvm tests/luks \
	tests/md tests/selinux tests/ntfsclone \
	tests/btrfs tests/xfs tests/charsets \
	tests/xml tests/mount-local tests/9p \
	tests/rsync tests/bigdirs \
	tests/disk-labels tests/hotplug \
	tests/nbd tests/http tests/syslinux \
	tests/journal tests/fuzz \
	tests/relative-paths tests/regressions
am__append_4 = p2v

# Language bindings.
am__append_5 = perl perl/examples
am__append_6 = ocaml ocaml/examples
am__append_7 = python python/examples
am__append_8 = ruby ruby/examples
am__append_9 = java java/examples
#am__append_10 = haskell
#am__append_11 = php
am__append_12 = erlang erlang/examples
#am__append_13 = lua lua/examples
am__append_14 = gobject
#am__append_15 = golang golang/examples
...
#am__append_17 = v2v/test-harness
...
#am__append_20 = po-docs
am__append_21 = html/guestfs-erlang.3.html
#am__append_22 = html/guestfs-golang.3.html
am__append_23 = html/guestfs-java.3.html
#am__append_24 = html/guestfs-lua.3.html
am__append_25 = html/guestfs-ocaml.3.html
am__append_26 = html/guestfs-perl.3.html
am__append_27 = html/guestfs-python.3.html
am__append_28 = html/guestfs-ruby.3.html
am__append_29 = \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/00gnulib.m4 \
	...
	$(top_srcdir)/m4/arpa_inet_h.m4 $(top_srcdir)/m4/base64.m4 \
	...
	$(top_srcdir)/m4/fsusage.m4 $(top_srcdir)/m4/ftell.m4 \
	...
	$(top_srcdir)/m4/glob.m4 $(top_srcdir)/m4/gnu-make.m4 \
	...
	$(top_srcdir)/m4/intmax_t.m4 $(top_srcdir)/m4/introspection.m4 \
	...
	$(top_srcdir)/m4/rmdir.m4 $(top_srcdir)/m4/safe-read.m4 \
	...
	$(top_srcdir)/m4/ttyname_r.m4 $(top_srcdir)/m4/ungetc.m4 \
	$(top_srcdir)/m4/unistd-safer.m4 $(top_srcdir)/m4/unistd_h.m4 \
	$(top_srcdir)/m4/unlink.m4 $(top_srcdir)/m4/unlinkat.m4 \
	$(top_srcdir)/m4/unlinkdir.m4 $(top_srcdir)/m4/utimbuf.m4 \
...
CONFIG_CLEAN_FILES = installcheck.sh php/extension/php-for-tests.sh \
	pick-guests.pl podwrapper.pl run \
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = gnulib/lib gnulib/tests tests/data generator src \
	examples po daemon tests/daemon appliance tests/qemu \
	tests/guests tests/c-api tests/tmpdirs tests/protocol \
	tests/events tests/parallel tests/create tests/disks \
	tests/discard tests/mountable tests/network tests/lvm \
	tests/luks tests/md tests/selinux tests/ntfsclone tests/btrfs \
	tests/xfs tests/charsets tests/xml tests/mount-local tests/9p \
	tests/rsync tests/bigdirs tests/disk-labels tests/hotplug \
	tests/nbd tests/http tests/syslinux tests/journal tests/fuzz \
	tests/relative-paths tests/regressions test-tool fish align \
	cat diff df edit format inspector make-fs rescue p2v bash perl \
	...
	golang/examples csharp mllib customize builder builder/website \
	dib get-kernel resize sparsify sysprep v2v v2v/test-harness \
	tools fuse po-docs
...
ACLOCAL = ${SHELL} /home/franklin/temp/libguestfs/build-aux/missing --run aclocal-1.11
ACL_LIBS = 
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
AUGEAS_LIBS = -laugeas  
AUTOCONF = ${SHELL} /home/franklin/temp/libguestfs/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/franklin/temp/libguestfs/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/franklin/temp/libguestfs/build-aux/missing --run automake-1.11
AWK = gawk
...
ERLANG_LIB_DIR_erl_interface = /usr/lib/erlang/lib/erl_interface-3.7.5
ERLANG_LIB_VER_erl_interface = 3.7.5
ERLC = /usr/bin/erlc
ERLCFLAGS = 
ERRNO_H = 
EXEEXT = 
EXTRA_JAVAC_FLAGS =  -Xlint:all
EXTRA_PACKAGES = 
FGREP = /bin/grep -F
FLOAT_H = 
FNMATCH_H = 
...
GNULIB_IOCTL = IN_LIBGUESTFS_GNULIB_TESTS
GNULIB_ISATTY = 1
GNULIB_ISWBLANK = 0
GNULIB_ISWCTYPE = 0
GNULIB_LCHMOD = 0
...
LUA_VERSION = 
MAGIC_LIBS = -lmagic
MAKEINFO = ${SHELL} /home/franklin/temp/libguestfs/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MAX_PROC_NR = 456
MKDIR_P = /bin/mkdir -p
MSGCAT = msgcat
...
PACKAGE_STRING = libguestfs 1.30.3
PACKAGE_TARNAME = libguestfs
PACKAGE_URL = 
PACKAGE_VERSION = 1.30.3
PACKAGE_VERSION_FULL = 1.30.3
PAMCUT = no
PATH_SEPARATOR = :
PBMTEXT = no
PCRE_CFLAGS =  
...
PNMTOPNG = no
PO4A = no
PODWRAPPER = perl /home/franklin/temp/libguestfs/podwrapper.pl
POSUB = po
PRAGMA_COLUMNS = 
...
STDINT_H = 
STRIP = strip
SUPERMIN = /usr/local/bin/supermin
...
YIELD_LIB = -lrt
ZIP = /usr/bin/zip
abs_aux_dir = /home/franklin/temp/libguestfs/build-aux
abs_builddir = /home/franklin/temp/libguestfs
abs_srcdir = /home/franklin/temp/libguestfs
abs_top_builddir = /home/franklin/temp/libguestfs
abs_top_srcdir = /home/franklin/temp/libguestfs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  asnprintf.o chdir-long.o fcntl.o fsusage.o fts.o futimens.o glob.o mbrtowc.o openat-proc.o printf-args.o printf-parse.o secure_getenv.o strerror_r.o vasnprintf.o xstrtoll.o xstrtoull.o
gl_LTLIBOBJS =  asnprintf.lo chdir-long.lo fcntl.lo fsusage.lo fts.lo futimens.lo glob.lo mbrtowc.lo openat-proc.lo printf-args.lo printf-parse.lo secure_getenv.lo strerror_r.lo vasnprintf.lo xstrtoll.lo xstrtoull.lo
gltests_LIBOBJS =  ioctl.o nanosleep.o
gltests_LTLIBOBJS =  ioctl.lo nanosleep.lo
...
install_sh = ${SHELL} /home/franklin/temp/libguestfs/build-aux/install-sh
...
SUBDIRS = gnulib/lib $(am__append_1) tests/data generator src examples \
	po $(am__append_2) $(am__append_3) test-tool fish align cat \
	diff df edit format inspector make-fs rescue $(am__append_4) \
	bash $(am__append_5) $(am__append_6) $(am__append_7) \
	$(am__append_8) $(am__append_9) $(am__append_10) \
	$(am__append_11) $(am__append_12) $(am__append_13) \
	$(am__append_14) $(am__append_15) csharp $(am__append_16) \
...
# The website.
HTMLFILES = html/guestfs.3.html html/guestfs-examples.3.html \
	html/guestfs-faq.1.html html/guestfs-performance.1.html \
	html/guestfs-recipes.1.html html/guestfs-release-notes.1.html \
	html/guestfs-testing.1.html html/guestfsd.8.html \
	html/guestfish.1.html \
	html/libguestfs-make-fixed-appliance.1.html \
	html/libguestfs-test-tool.1.html \
	html/virt-alignment-scan.1.html html/virt-builder.1.html \
	html/virt-cat.1.html html/virt-copy-in.1.html \
	html/virt-copy-out.1.html html/virt-customize.1.html \
	html/virt-df.1.html html/virt-dib.1.html html/virt-diff.1.html \
	html/virt-edit.1.html html/virt-filesystems.1.html \
	html/virt-format.1.html html/virt-get-kernel.1.html \
	html/virt-inspector.1.html html/virt-list-filesystems.1.html \
	html/virt-list-partitions.1.html html/virt-log.1.html \
	html/virt-ls.1.html html/virt-make-fs.1.html \
	html/virt-rescue.1.html html/virt-resize.1.html \
	html/virt-sparsify.1.html html/virt-sysprep.1.html \
	html/virt-tar.1.html html/virt-tar-in.1.html \
	html/virt-tar-out.1.html html/virt-v2v.1.html \
	html/virt-win-reg.1.html $(am__append_21) $(am__append_22) \
...
installcheck.sh: $(top_builddir)/config.status $(srcdir)/installcheck.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
php/extension/php-for-tests.sh: $(top_builddir)/config.status $(top_srcdir)/php/extension/php-for-tests.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pick-guests.pl: $(top_builddir)/config.status $(srcdir)/pick-guests.pl.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
podwrapper.pl: $(top_builddir)/config.status $(srcdir)/podwrapper.pl.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
run: $(top_builddir)/config.status $(srcdir)/run.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
builder/test-config/virt-builder/repos.d/test-index.conf: $(top_builddir)/config.status $(top_srcdir)/builder/test-config/virt-builder/repos.d/test-index.conf.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
builder/test-website/virt-builder/repos.d/libguestfs.conf: $(top_builddir)/config.status $(top_srcdir)/builder/test-website/virt-builder/repos.d/libguestfs.conf.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
ruby/ext/guestfs/extconf.rb: $(top_builddir)/config.status $(top_srcdir)/ruby/ext/guestfs/extconf.rb.in
	cd $(top_builddir) && $(SHELL) ./config.status $@

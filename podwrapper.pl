...
# podwrapper.pl.  Generated from podwrapper.pl.in by configure.
#
...
my $abs_top_srcdir = "/home/franklin/temp/libguestfs";
my $abs_top_builddir = "/home/franklin/temp/libguestfs";
my $package_name = "libguestfs";
my $package_version = "1.30.3";
